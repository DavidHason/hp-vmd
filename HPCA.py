...
# # Feature Engineering- Speech Emotion Recognition (SER) HPCA
# DavidH
...
ROOT_DIR = '../19012022_experiment/fold'
...
validation_features, test_features, validation_labels, test_labels =                                                         train_test_split(validation_features, validation_labels, test_size = 0.5, shuffle = True)
